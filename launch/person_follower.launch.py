...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[LaunchConfiguration('params_file')],
            output='screen',
            # Add remappings if your camera topics are different
            remappings=[
                ('/stereo/left/image_rect', '/camera/left/image_raw'),
                ('/stereo/right/image_rect', '/camera/right/image_raw'),
        ...
        Node(
            ...
            executable='rviz2',
            name='rviz2',
            arguments=['-d', os.path.join(pkg_dir, 'config', 'person_follower.rviz')],
            output='screen'
        )
    ])